...
<script type="text/javascript" src="{{asset('manager/menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('manager/menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('manager/menu/menu.js')}}"></script>