			...
			<div class="col-lg-12">
				<div class="intro-message">
					...
					<ul class="list-inline intro-social-buttons">
						<li>
							<a class="btn btn-primary btn-lg mt-3" href="https://twitter.com/SBootstrap"><span class="network-name">Twitter</span></a>
						</li>
						<li>
							<a class="btn btn-primary btn-lg mt-3" href="https://github.com/IronSummitMedia/startbootstrap"><span class="network-name">Github</span></a>
						</li>
						<li>
							<a class="btn btn-primary btn-lg mt-3" href="#"><span class="network-name">Linkedin</span></a>
						</li>
					</ul>
				</div>
			</div>
...
<div class="content-section-a">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-5 col-lg-offset-2 col-sm-6"><img alt="" class="img-responsive" src="{{asset('themes/' . setting('theme_active') . '/img/ipad.png')}} "></div>
		</div>
	</div><!-- /.container -->
...
<div class="content-section-b">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-5 col-sm-pull-6 col-sm-6"><img alt="" class="img-responsive" src="{{asset('themes/' . setting('theme_active') . '/img/dog.png')}}"></div>
		</div>
	</div><!-- /.container -->
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5 col-sm-6">
				...
				<p class="lead">This template features the 'Lato' font, part of the <a href="http://www.google.com/fonts" rel="noopener" target="_blank">Google Web Font library</a>, as
				well as <a href="http://fontawesome.io" rel="noopener" target="_blank">icons from Font
				Awesome</a>.</p>
			</div>
			<div class="col-lg-5 col-lg-offset-2 col-sm-6"><img alt="" class="img-responsive" src="{{asset('themes/' . setting('theme_active') . '/img/phones.png')}}"></div>
		</div>
	</div><!-- /.container -->
</div><!-- /.content-section-a -->
